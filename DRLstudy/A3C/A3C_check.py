...
from source import A3C, SharedAdam, plot, play_and_save
...
for i in range(repeat):
    ...
    for rank in range(process_num):
        ...
        p = mp.Process(target=agent.train, args=(env, max_episode,process_num, evaluate_period, evaluate_num, update_period,
